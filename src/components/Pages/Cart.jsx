        ...
        <div className="col-span-9 space-y-4">
          {carts.map((item) => (
            ...
            ><div className="w-28 flex-shrink-0">
              ...
              <button
                  className="px-6 py-2 text-center text-sm text-white  bg-green-600 border border-green-600 rounded hover:bg-transparent hover:text-green-600 transition uppercase font-roboto font-medium"
                >
                  Buy
                </button>
                ...
                <div className="text-gray-600 cursor-pointer hover:text-[#106F97]">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="40" fill="currentColor" class="bi bi-trash3 ml-5" viewBox="0 0 16 16" onClick={() => removeCart(item.id)}>
