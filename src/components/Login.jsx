          ...
          <div className="md:w-1/2 px-16">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleLogin}>
              ...
              <div className="relative">
                ...
                {icon && <svg xmlns="http://www.w3.org/2000/svg" onClick={clicked} width="16" height="16" fill="currentColor" class="bi bi-eye-slash absolute top-1/2 right-3 -translate-y-1/2" viewBox="0 0 16 16">
