  ...
  return (
    <div className='flex flex-col justify-between shadow-xl rounded-md p-5 w-[250px]' >
      ...
      <div className="text-red-500 cursor-pointer hover:text-red-500">
        {/* red heart         */}
   {icon &&    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="mt-2 h-9 fill-red-500 hover:fill-red-600 absolute" onClick={(event) => addWishlist(props, event)}>
      <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
    </svg>  }
    {/* red heart */}
    {/* white heart */}
   {!icon && <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-heart mt-2 h-9 fill-red-500 hover:fill-red-600 absolute" viewBox="0 0 16 16" onClick={(event) => addWishlist(props, event)}>
