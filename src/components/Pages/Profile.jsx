...
return (
  ...
  <div>
      <section className="justify-center">
        <div className="bg-gray-100 flex  rounded-2xl shadow-lg p-5 items-center w-full ">
          
          <img className='' src='assets/profile.jpg' alt='profile'></img>
          <div className='sm:ml-10 md:ml-10'>
            <p className='text-4xl flex tranistion uppercase'>{data.firstName} {data.lastName}</p>
