          ...
          {carts.map((item) => (
            ...
            ><div className="w-28 flex-shrink-0">
              ...
              <div className="flex gap-2">
                <button
                  onClick={(id)=>clicked(item.id)} className="px-6 py-2 text-center text-sm text-white  bg-green-600 border border-green-600 rounded hover:bg-transparent hover:text-green-600 transition uppercase font-roboto font-medium"
                >
                  Buy
                </button>
