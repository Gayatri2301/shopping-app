  ...
  return (
    <div className='flex flex-col justify-between shadow-xl rounded-md p-5 w-[250px]' >
      ...
      <div className="text-red-500 cursor-pointer hover:text-red-500">
        {/* red heart         */}
   {wishItem &&    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="mt-2 h-9 fill-red-500 hover:fill-red-600 absolute" onClick={(event) => addWishlist(props, event)}>
